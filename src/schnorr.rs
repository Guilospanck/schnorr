...
///     assert!(schnorr::schnorr::sign_ecdsa(&secp, msg, seckey.to_vec()).is_ok());
/// ```
...
///     let signature_ecdsa = schnorr::schnorr::sign_ecdsa(&secp, msg.clone(), seckey.to_vec())
///      .unwrap();
///      assert!(schnorr::schnorr::verify_ecdsa(&secp, msg, signature_ecdsa, pubkey).is_ok());
/// ```
...
///     let msg = hashed_msg.to_hex();
///     let secp = Secp256k1::new();
///     assert!(schnorr::schnorr::sign_schnorr(&secp, msg, seckey.to_vec()).is_ok());
/// ```
...
///
///     let secp = Secp256k1::new();
///     let sig = match secp256k1::schnorr::Signature::from_str("bf073c935f71de50ec72bdb79f75b0bf32f9049305c3b22f97c06422c6f2edc86e0d7e07d7d7222678b238b1daee071be5f6fa653c611971395ec0d1c6407caf") {
///       Ok(signature) => signature,
///       Err(_) => return,
///     };
///     let id = "00960bd35499f8c63a4f65e79d6b1a2b7f1b8c97e76652325567b78c496350ae".to_string(); // already hashed message
///     let pubkey = "614a695bab54e8dc98946abdb8ec019599ece6dada0c23890977d0fa128081d6".to_string();
///     let result = match schnorr::schnorr::verify_schnorr(&secp, id.clone(), sig, pubkey.clone()) {
///       Ok(result) => result,
///       Err(_) => return,
///     };
